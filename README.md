...
* **logs/** : log files made by trace-pc-guard for each input file. This is for debugging, thus you can choose not to make this directory by not defining `DEBUG_COV` in src/funcov.c
