...
// alloc_fail:
//     perror("reallocate_maps: realloc") ;
//     exit(1) ;
// }

// void
// update_fun_names (p_entry_t * trace, char * buf, int index)
// {
...
// void
// get_bitmap (p_entry_t * trace, cov_stat_t * stat, config_t * conf, int turn)
// {
...
// int
// get_cov_stats (p_entry_t ** trace, cov_stat_t * stat, config_t * conf, int turn, int exit_code)
// {
//     stat->id = turn ;
//     stat->exit_code = exit_code ;

//     get_bitmap(trace, stat, conf, turn) ;
